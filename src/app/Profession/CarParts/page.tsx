...
export default function CarPats() {
                ...
                <div className='w-auto max-w-[1280px] py-16 space-y-16 m-auto'>
                    <div>
                        ...
                        <p className='text-lg text-black/80 leading-9'>
                            汽车零部件制造要求高精度、耐用性、轻量化及环保性能。我们凭借先进的制造工艺、精密加工设备、严格的质量控制体系以及创新研发能力，能够完全满足这些需求。无论是发动机部件、车身结构还是电子系统，我们都能确保产品的高性能与可靠性。同时，我们注重绿色制造，采用环保材料与工艺，助力汽车行业可持续发展，为客户提供卓越的零部件解决方案。
                        </p>
                    </div>
                </div>
                <div className='py-16'>
                    ...
                    <div className='h-auto relative max-w-[1280px] grid grid-cols-5 gap-5 m-auto'>
                        <div
                            className='flex  flex-shrink-0 items-center h-[50px] bg-slate-100 p-5 box-border hover:bg-slate-300 hover:rounded-lg duration-200'>
                            原型设计
                        </div>
                        <div
                            className='flex  flex-shrink-0 items-center h-[50px] bg-slate-100 p-5 box-border hover:bg-slate-300 hover:rounded-lg duration-200'>
                            ...
                            <div className='relative h-full w-full'>
                                <div className='h-full w-full relative  bg-white transform-none'>
                                    ...
                                    <div className='h-[350px] p-8 bg-gray-50'>
                                        <p className='font-bold text-2xl mb-4 py-2'>汽车制造认证是ISO
                                            9001认证，我们的供应商有专门的认证。</p>
                            ...
                            <div className='relative h-full w-full'>
                                <div className='h-full w-full relative  bg-white transform-none'>
                                    ...
                                    <div className='h-[300px] p-2 px-5 bg-gray-50'>
                                        ...
                                        <Link href='/Ability/CNCMachiningServices'
                                              className='flex py-1 text-sm text-blue-900 group'>
                                            查看我们的CNC加工服务
                            ...
                            <div className='relative h-full w-full'>
                                <div className='h-full w-full relative  bg-white transform-none'>
                                    ...
                                    <div className='h-[300px] p-2 px-5 bg-gray-50'>
                                        ...
                                        <Link href='/Ability/SheetMetalProcessingServices'
                                              className='flex py-1 text-sm text-blue-900 group'>
                                            查看我们的钣金制造服务
                                            <i className='group-hover:block hidden iconfont icon-jiantou ml-4'></i>
                                        </Link>
                            ...
                            <div className='relative h-full w-full'>
                                <div className='h-full w-full relative  bg-white transform-none'>
                                    ...
                                    <div className='h-[300px] p-2 px-5 bg-gray-50'>
                                        ...
                                        <Link href='/Ability/InjectionMoldingServices'
                                              className='flex py-1 text-sm text-blue-900 group'>
                                            查看我们的注塑成型服务
                                            <i className='group-hover:block hidden iconfont icon-jiantou ml-4'></i>
                                        </Link>
