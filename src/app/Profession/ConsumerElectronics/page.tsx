                ...
                <div className='w-auto max-w-[1280px] py-16 space-y-16 m-auto'>
                    <div>
                        ...
                        <p className='text-lg text-black/80 leading-9'>
                            在快速变化的消费电子市场中，创新速度决定了企业的成败。燧研智算为您提供一站式智能制造服务，涵盖3D打印、CNC加工、钣金及注塑加工，助力您快速从创意走向量产。我们的专业设计支持团队确保每个细节都完美呈现，同时借助即时报价系统和强大供应链网络，为您定制最优解决方案。缩短开发周期，提升生产效率，燧研智算助您轻松应对复杂的制造需求，让创新更快落地。立即加入我们，开启您的高效智造之旅！
                        </p>
                    </div>
                </div>
                <div className='py-16'>
