                ...
                <div className='w-full flex'>
                    <div className=' float-left'>
                        ...
                        <img alt="Img" loading="lazy" width="957" height="900" decoding="async" data-nimg="1"
                             ...
                             src="https://www.quicklyre.com/head/gyjx.png"/>
                    </div>
                ...
                <div className='w-auto max-w-[1280px] py-16 space-y-16 m-auto'>
                    <div>
                        ...
                        <p className='text-lg text-black/80 leading-9'>
                            在燧研智算，我们专注于为您提供高质量的工业机械部件解决方案。无论是复杂零件还是大批量生产，我们的即时报价平台和严格质量控制确保您以最优价格快速获取所需产品。依托行业领先的供应商网络和技术能力，燧研智算是您可靠的工业智造伙伴，助您轻松完成原型设计、技术验证及大规模生产，让您的机器运行无忧。立即下单，体验高效精准的工业智造服务！
                        </p>
                    </div>
                </div>
                <div className='py-16'>
                    ...
                    <div className='h-auto relative max-w-[1280px] grid grid-cols-4 gap-5 m-auto'>
                        <div className='flex  flex-shrink-0 items-center h-[50px] bg-slate-100 p-5 box-border hover:bg-slate-300 hover:rounded-lg duration-300'>
                            活动部件
                        </div>
                        <div className='flex  flex-shrink-0 items-center h-[50px] bg-slate-100 p-5 box-border hover:bg-slate-300 hover:rounded-lg duration-300'>
                            套管
