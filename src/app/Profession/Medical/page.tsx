                ...
                <div className='w-full flex'>
                    <div className=' float-left'>
                        ...
                        <img alt="Img" loading="lazy" width="957" height="900" decoding="async" data-nimg="1"
                             ...
                             src="https://www.quicklyre.com/head/yl.png"/>
                    </div>
                ...
                <div className='w-auto max-w-[1280px] py-16 space-y-16 m-auto'>
                    <div>
                        ...
                        <p className='text-lg text-black/80 leading-9'>
                            燧研智算致力于为医疗领域提供精准高效的制造解决方案。无论是3D打印、CNC加工、钣金还是注塑加工，我们的平台都能快速响应需求，助力创新。从诊断设备到手术器械，我们支持您将创意转化为现实，推动医学进步，改善患者护理体验。立即加入燧研智算，开启您的医疗设备智造之旅！
                        </p>
                    </div>
                </div>
                <div className='py-16'>
                    ...
                    <div className='h-auto relative max-w-[1280px] grid grid-cols-5 gap-5 m-auto'>
                        <div
                            className='flex  flex-shrink-0 items-center h-[50px] bg-slate-100 p-5 box-border hover:bg-slate-300 hover:rounded-lg duration-300'>
                            Med-tech原型
                        </div>
                        <div
                            className='flex  flex-shrink-0 items-center h-[50px] bg-slate-100 p-5 box-border hover:bg-slate-300 hover:rounded-lg duration-300'>
                            ...
                            <div className='relative h-full w-full'>
                                <div className='h-full w-full relative  bg-white transform-none'>
                                    ...
                                    <div className='h-[350px] p-8 bg-gray-50'>
                                        <p className='font-bold text-2xl mb-4 py-2'>航空航天和航空认证是ISO
