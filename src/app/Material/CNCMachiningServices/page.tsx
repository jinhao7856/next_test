                ...
                <div className='max-w-[1280px] '>
                                ...
                                <table className='w-full caption-bottom text-sm boeder border-gray-300'>
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-5052-H112
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-6063-T5
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-6082-T6
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-6061-T6511
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-2014-T6
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-6061-T651
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-6061
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-2024-T351
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-5083-H32
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>铝-6082-T651
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                    ...
                    <div className='py-16 w-full flex gap-10'>
                        ...
                        <div className='p-12 w-1/2 border rounded border-gray-300'>
                            ...
                            <p className='text-base text-justify leading-8 pt-8'>
                                我们的服务使设计师和工程师能够为航空航天、汽车、国防、工业自动化、机械、制造、医疗设备、硬件设置、能源和机器人等行业的许多应用创建定制的 CNC部件。我们使用机器学习算法将 CAD 文件转换为定制零件的报价，确保您的设计在到达制造合作伙伴之前具有可制造性。我们的平台提供适合生产零件的各种材料和技术。
