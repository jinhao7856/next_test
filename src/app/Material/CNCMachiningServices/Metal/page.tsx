                        ...
                        <div className='p-10 border rounded relative border-gray-300 '>
                            ...
                            <div className='relative w-full overflow-auto '>
                                <table className='w-full caption-bottom text-sm boeder border-gray-300'>
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>黄铜-H62
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>黄铜-H59
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>纯铅
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                        ...
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>金属
                                            </div>
                                        </td>
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>纯铁-TD4C
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
                                    ...
                                    <tr className='border-b border-gray-300 transition-colors hover:bg-gray-200 h-16'>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>钢-35#
                                            </div>
                                        </td>
                                        <td className='p-2 align-middle'>
                                            <div className='text-[14px]  text-black/80 font-bold'>-
