...
import {InputLabel, List, ListItem, ListItemText, MenuItem} from "@mui/material";
...
export default function MyQuote() {
    ...
    return (
        <div
            ...
            <div className='flex box-border w-[calc(100%_-_80px)]'>
                        ...
                        <div className='h-full'>
                            <div className='bg-white p-5 rounded-lg'>
                                ...
                                <div className='flex gap-3 flex-wrap my-8'>
                                    <div className='w-60'>
                                        <div className='w-[240px] h-[30px] flex justify-center'>
                                            <div className='w-9/10 h-full'>
                                                <Select
                                                    ...
                                                    allowClear
                                                    options={[
                                                        {value: '1', label: <span>CNC加工服务</span>},
                                                        {value: '2', label: <span>3D打印服务</span>},
                                                        {value: '3', label: <span>注塑加工服务</span>},
                                                        {value: '4', label: <span>钣金加工服务</span>},
                                                    ]}
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className='w-60'>
                                        <div className='w-[240px] h-[30px] flex justify-center'>
                                            <div className='w-9/10 h-full flex'>
                                                <Input placeholder='输入报价编号 '/>
                                                <span
                                                    className='w-[40px] border border-gray-300 flex items-center justify-center text-gray-300'>
                                ...
                                <div className=''>
                                    <table className='table-fixed w-full min-w-1'>
                                        ...
                                        <tr className='text-[14px]'>
                                            ...
                                            <th className='w-10'>零件</th>
                                            <th className='w-10'>材料</th>
                                            <th className='w-10'>数量</th>
                                            <th className='w-10'>状态</th>
                                            <th className='w-10'>总价</th>
                                            <th className='w-10'>报价时间</th>
