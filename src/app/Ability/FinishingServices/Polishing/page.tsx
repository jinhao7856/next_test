        ...
        <div>
            ...
            <div className='bg-white pb-16 px-10 xl:px-0'>
                    ...
                    <div className='px-40 bg-gray-900 h-full pt-20'>
                        <div className='max-w-[1280px] m-auto'>
                            ...
                            <p className='text-white font-light w-9/12 text-base text-justify  leading-8'>
                                我们的抛光服务专注于提升工件表面质量，赋予产品更卓越的外观与性能。无论是去除毛刺、平整表面还是打造镜面光泽，我们的专业团队都将严格按照客户需求，采用先进的设备和精湛工艺，确保每一件成品都能达到最佳效果。
                            </p>
                        ...
                        <div className='relative w-full overflow-auto '>
                            <table className='w-full caption-bottom text-sm '>
                                ...
                                <tr className='border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted'>
                                    <th className='h-10 px-2 text-left align-middle font-medium text-muted-foreground '>表面特征表</th>
                                    <th className='h-10 px-2 text-left align-middle font-medium text-muted-foreground '>面粗糙度(Ra)数值</th>
                                    <th className='h-10 px-2 text-left align-middle font-medium text-muted-foreground '>加工方法举例</th>
                                </tr>
                                </thead>
                                <tbody className='border-0'>
                                <tr className='border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted h-16'>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>明显可见刀痕
                                        </div>
                                    </td>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>Ra100、Ra50、Ra25
                                        </div>
                                    </td>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>粗车、粗刨、粗铣、钻孔</div>
                                    </td>
                                </tr>
                                <tr className='border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted h-16'>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>微见刀痕
                                        </div>
                                    </td>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>Ra12.5、Ra6.3、Ra3.2
                                        </div>
                                    </td>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>精车、精刨、精铣、粗铰、粗磨</div>
                                    </td>
                                </tr>
                                <tr className='border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted h-16'>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>看不见加工痕迹，微辩加工方向
                                        </div>
                                    </td>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>Ra1.6、Ra0.8、Ra0.4
                                        </div>
                                    </td>
                                    <td className='p-2 align-middle'>
                                        <div className='text-[14px]  text-black/80 font-bold'>精车、精磨、精铰、研磨</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div className='py-16 max-w-[1280px] m-auto'>
                    <h3 className='w-full text-center text-black/90 font-bold text-5xl '>抛光部件示例</h3>
                                ...
                                <div className='relative h-full w-full'>
                                    ...
                                    <div className='h-full w-full relative bg-gray-50 dark:bg-black group-hover:translate-x-6  transition duration-500'>
                                        <img alt="image" loading="lazy" width="1000" height="1000" decoding="async"
                                             ...
                                             src='https://zhenkekeji.oss-cn-hangzhou.aliyuncs.com/public/details/Polishing/1-1.png'/>
                                    </div>
                            ...
                            <div className='md:h-96 h-60 bg-transparent rounded-lg overflow-hidden group/card relative'>
                                <div className='relative h-full w-full'>
                                    ...
                                    <div className='h-full w-full relative bg-gray-50 dark:bg-black group-hover:translate-x-6  transition duration-500'>
                                        <img alt="image" loading="lazy" width="1000" height="1000" decoding="async"
                                             className='h-full w-full object-cover scale-[1.15] text-transparent'
                                             src='https://zhenkekeji.oss-cn-hangzhou.aliyuncs.com/public/details/Polishing/1-2.png'/>
                                    </div>
